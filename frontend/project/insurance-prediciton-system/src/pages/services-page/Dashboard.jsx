...
import { Calculator, Plus, BarChart3, Calendar } from "lucide-react";
      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-4">
          <button
            ...
            className="flex items-center space-x-2 bg-gradient-to-r from-[#3a8dad] to-[#78c6ff] text-white px-6 py-3 rounded-lg cursor-pointer hover:from-[#327c94] hover:to-[#5fb9ff] transition-all duration-200 shadow-lg"
          >
            <Plus className="w-5 h-5" />
            <span>New Prediction</span>
          </button>
          <Link
            to="/services-page/history"
